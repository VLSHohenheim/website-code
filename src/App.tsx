...
function App() {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'dark' : ''}`}>
      ...
      {/* Willkommen-Sektion */}
      <section id="welcome" className="min-h-screen bg-fixed bg-cover bg-center"
        style={{ backgroundImage: "url('...')" }}>
          <div className="h-full py-32 flex items-start justify-center bg-black bg-opacity-50">
